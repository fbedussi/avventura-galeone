module.exports = {
    n: () => `Di qui non si passa, questa ha tutta l'aria di essere la chiglia della nave`,
    s: () => `Di qui non si passa, questa ha tutta l'aria di essere la chiglia della nave`,
